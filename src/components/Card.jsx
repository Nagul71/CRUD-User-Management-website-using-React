...
function Card({data}) {
    const {title,salary,icon,color,isProgress} = data;
  return <>
            ...
            <div className="row no-gutters align-items-center">
                {
                    ...
                    <div className="col mr-2">
                        ...
                        <div className="row no-gutters align-items-center">
                            <div className="col-auto">
                                <div className="h5 mb-0 mr-3 font-weight-bold text-gray-800">{salary}%</div>
                            </div>
                            <div className="col">
                                <div className="progress progress-sm mr-2">
                                    <div className={`progress-bar bg-${color}`} role="progressbar"
                                        style={{width: `${salary}%`, ariaValueNow:"50", AriaValueMin:"0",
                    ...
                    <div className="col mr-2">
                        ...
                        <div className="h5 mb-0 font-weight-bold text-gray-800">{salary}</div>
                    </div>
                    <div className="col-auto">
                        <i className={`fas ${icon} fa-2x text-gray-300`}></i>
                    </div>
